...
function startGame() {
    ...
    fetch(baseApiUrl + 'heightmap/diamondSquare', {
        ...
        var ground = BABYLON.Mesh.CreateGroundFromHeightMap('myGround', baseApiUrl + 'heightmap/' + guid, 256, 256, 300, 0, 15, scene);
...
function createSkyBox(scene: BABYLON.Scene): void {
    ...
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("textures/miramar", scene);
...
function createTerrainMaterial(scene: BABYLON.Scene, splatmapUrl: string): any {
    ...
    // terrainMaterial.diffuseTexture1 = new BABYLON.Texture("textures/grass.jpg", scene);
    // terrainMaterial.diffuseTexture2 = new BABYLON.Texture("textures/rock.jpg", scene);
    // terrainMaterial.diffuseTexture3 = new BABYLON.Texture("textures/snow.jpg", scene);
...
function createScene(): BABYLON.Scene {
    ...
    scene.clearColor = new BABYLON.Color4(0.275, 0.82, 1, 1);
...
function createFreeCamera(scene) {
    let cam = new BABYLON.UniversalCamera('universalCamera', new BABYLON.Vector3(0, 50, -10), scene);
...
function sendPosition(position: BABYLON.Vector3): void {
